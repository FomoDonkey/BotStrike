...
export function FooterBar({ className }: { className?: string }) {
  ...
  return (
    <footer className={cn("items-center h-8 bg-bg border-t border-hairline shrink-0 text-[12.5px] select-none min-w-0", className)}>
      ...
      <span className="hidden xl:inline-flex items-center gap-1.5 px-3 h-full border-r border-hairline font-medium text-text whitespace-nowrap shrink-0" title="Age of the last market update (a trade or a mark) from the venue the engine is connected to">
