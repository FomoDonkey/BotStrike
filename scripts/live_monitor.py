...
class LiveDashboard:
    ...
    def _build_strat_panel():
        ...
        t2.add_row("[green]MR 40%", "[green]Divergence RSI+OBV[/] on 15m (auto-resample)")
        t2.add_row("Entry", "Price new low + RSI was <30 + RSI recovers >45 + OBV confirms")
        t2.add_row("SL/TP", "1.5x / 3.0x ATR (R:R 1:2)  |  ADX < 35  |  Dip confirmation")
        t2.add_row("", "")
